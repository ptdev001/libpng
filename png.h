...
#define PNG_HEADER_VERSION_STRING " libpng version 1.6.21 - January 15, 2016\n"
...
extern "C"
{
  ...
  PNG_EXPORT(14,
             void,
             png_write_chunk,
             (png_structrp png_ptr, png_const_bytep chunk_name, png_const_bytep data, png_size_t length));
  ...
  PNG_EXPORTA(
    23, png_const_charp, png_convert_to_rfc1123, (png_structrp png_ptr, png_const_timep ptime), PNG_DEPRECATED);
    #endif
  ...
  PNG_FIXED_EXPORT(208,
                   void,
                   png_set_gamma_fixed,
                   (png_structrp png_ptr, png_fixed_point screen_gamma, png_fixed_point override_file_gamma))
  #endif
...
PNG_EXPORTA(104, void, png_err, (png_const_structrp png_ptr), PNG_NORETURN);
  ...
  PNG_FIXED_EXPORT(138,
                   png_uint_32,
                   png_get_gAMA_fixed,
                   (png_const_structrp png_ptr, png_const_inforp info_ptr, png_fixed_point* int_file_gamma))
  #endif
  ...
  PNG_FIXED_EXPORT(
    ...
    png_uint_32,
    png_get_sCAL_fixed,
    (png_const_structrp png_ptr, png_const_inforp info_ptr, int* unit, png_fixed_point* width, png_fixed_point* height))
    #endif
  PNG_EXPORT(169,
             png_uint_32,
             png_get_sCAL_s,
             (png_const_structrp png_ptr, png_const_inforp info_ptr, int* unit, png_charpp swidth, png_charpp sheight));
  ...
  PNG_FIXED_EXPORT(
    ...
    void,
    png_set_sCAL_fixed,
    (png_const_structrp png_ptr, png_inforp info_ptr, int unit, png_fixed_point width, png_fixed_point height))
  PNG_EXPORT(
    171,
    void,
    png_set_sCAL_s,
  ...
  #define PNG_PASS_ROWS(height, pass) \
    (((height) + (((1 << PNG_PASS_ROW_SHIFT(pass)) - 1) - PNG_PASS_START_ROW(pass))) >> PNG_PASS_ROW_SHIFT(pass))
  #define PNG_PASS_COLS(width, pass) \
    (((width) + (((1 << PNG_PASS_COL_SHIFT(pass)) - 1) - PNG_PASS_START_COL(pass))) >> PNG_PASS_COL_SHIFT(pass))
  ...
  #define PNG_COL_IN_INTERLACE_PASS(x, pass) ((PNG_PASS_MASK(pass, 1) >> ((x)&7)) & 1)
    ...
    #define png_composite(composite, fg, alpha, bg)                                                            \
      (composite) = (png_byte)(0xff & (((png_uint_16)(fg) * (png_uint_16)(alpha) +                             \
  ...
  /* No png_save_int_16 -- may be added if there's a real need for it. */
    ...
    #define PNG_get_uint_32(buf)                                                                                  \
      (((png_uint_32)(*(buf)) << 24) + ((png_uint_32)(*((buf) + 1)) << 16) + ((png_uint_32)(*((buf) + 2)) << 8) + \
       ((png_uint_32)(*((buf) + 3))))
    ...
    #define PNG_get_int_32(buf)                                                                                \
      ((png_int_32)((*(buf)&0x80) ? -((png_int_32)(((png_get_uint_32(buf) ^ 0xffffffffU) + 1U) & 0x7fffffffU)) \
